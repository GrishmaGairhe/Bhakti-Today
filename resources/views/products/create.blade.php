...
<form action="{{route('products.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex justify-center">
            <button type="submit" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 px-6 py-2 rounded text-white font-medium transition-all duration-200 shadow-lg">Create Product</button>
            <a href="{{route('products.index')}}" class="bg-gradient-to-r from-gray-400 to-gray-500 hover:from-gray-500 hover:to-gray-600 px-6 py-2 rounded text-white font-medium transition-all duration-200 shadow-lg ml-3">Cancel</a>
        </div>
    </form>
@endsection